    ...
    <section id="templates" className="relative bg-white py-24 dark:bg-dark-card">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mt-20">
          <div className="absolute left-8 top-0 hidden h-full w-px bg-gradient-to-b from-blue-200 via-blue-300 to-blue-200 dark:from-blue-900 dark:via-blue-800 dark:to-blue-900 lg:block" />
